...
<div class="mian_top_01">
    ...
    %>
    <div class="mian_b">
        <form action="/notice/updatenotice?id=<%=notice.getNotice_id()%>" method="post">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mian_b_bg_xz">
                <tr>
                    <td width="5%" class="mian_b_bg_lm">&nbsp;</td>
                    <td colspan="3" class="mian_b_bg_lm">更新公告</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td width="55%">
                        <input type="text" class="input_01" name="noticename" placeholder="<%=notice.getNotice_title()%>" id="textfield"> </td>
                    <td width="35%">&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    ...
                    <td>
                        <textarea style="width:400px;height:130px;" name="noticeintro" placeholder="<%=notice.getNotice_content()%>"></textarea>
                    </td>
