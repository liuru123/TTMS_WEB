...
%>
<form class="mian_top_01" action="/employee/changeemp?id=<%=employee.getEmp_id()%>" method="post">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="mian_b_bg_xz">
            ...
            <tr style="background-color: White; height: 30px" id="mysub">
                <td align="center" colspan="8">
                    <input type="image" src="/images/bnt_03.gif" name="img" style="margin-top:8px; margin-right: 10px;" width="80" height="22" onclick="return checkmess();" >
